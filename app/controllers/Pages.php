...
class Pages extends Controller {
	...
	function admin_emailtemplate() {
		...
		if ($this->post('emailtemplate')) {
            file_put_contents(VIEWS_DIR . DIRECTORY_SEPARATOR .'activation-email-template.html', $this->post('emailtemplate'));
        }
        $contents = file_get_contents(VIEWS_DIR . DIRECTORY_SEPARATOR .'activation-email-template.html');
	...
	function admin_settings() {
		$this->admin_init();
		$config_file = file_get_contents(ROOT_DIR . DIRECTORY_SEPARATOR . 'config.php');
		...
		if (!empty($this->post())) {
		    ...
		    file_put_contents(ROOT_DIR . DIRECTORY_SEPARATOR .'config.php', $config_file);
