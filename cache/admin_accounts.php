...
<div class="links">
    <a href="<?php echo "https://users/admin/account" ?>">Create Account</a>
</div>
    ...
    <div class="table">
        <table>
            ...
            <tbody>
                ...
                <tr class="details" onclick="location.href='<?php echo "https://users/" ?>admin/account/<?php echo $account['id'] ?>'">
